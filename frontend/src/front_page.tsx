        ...
        <div className="max-w-5xl mx-auto">
          <div className="border rounded-lg p-4">
            ...
            <div className="mt-2 text-sm">
              Label: <span className="font-mono">{upload.document.predicted_label}</span>
            </div>
            ...
            <div className="mt-3 space-y-3">
              {upload.chunks.map((c) => (
                <button key={c.chunk_id} onClick={() => handleExplain(c.chunk_id)}
                  className="w-full text-left border rounded-lg p-3 bg-white text-gray-900 hover:bg-gray-50
